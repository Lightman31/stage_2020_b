...
void moove_chariot()
{
  ...
  */
  ...
  response[0] = byte (val%10);
  val = val-val%10;
  response[1] = byte ((val%100)/10);
  val = val-val%100;
  response[2] = byte ((val%1000)/100);
  val = val-val%1000;
  response[3] = byte ((val%10000)/1000);
  val = val-val%10000;
  response[4] = byte ((val%100000)/10000);
