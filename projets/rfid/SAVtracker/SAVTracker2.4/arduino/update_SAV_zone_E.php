<?php
	...
	if ($res['num_sav'] != "")
	{
		$req = $bdd->query('INSERT INTO Emplacement(sav,inf_dat_emplacement,nom_emplacement) VALUES((SELECT SAV.id_sav FROM SAV where SAV.UID = '.$_GET['UID'].'),NOW(),"Zone Electronique");'); 
